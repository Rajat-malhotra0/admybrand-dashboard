...
async function comprehensiveSeed() {
  try {
    console.log('🌱 Starting comprehensive database seeding with Facebook data...');
    ...
    console.log('✨ Facebook data now fully populated with influencers and campaigns');
  } catch (error) {
...
if (require.main === module) {
  comprehensiveSeed()
    .then(() => {
      console.log('Comprehensive seed script finished.');
      process.exit(0);
    })
    .catch((error) => {
