        ...
        <table className="min-w-full divide-y divide-border">
          <thead>
            <tr>
              ...
              <th 
                className="px-sm md:px-md py-xs md:py-sm text-left text-xs font-medium text-text-muted uppercase tracking-wider cursor-pointer hover:text-primary transition-colors select-none"
                  ...
                  <PaginationLink
                    ...
                    className={`cursor-pointer min-w-[40px] h-10 ${
                      currentPage === page
                        ...
                        : 'hover:bg-bg-tertiary border-border'
                    }`}
                  >
                    {page}
                  </PaginationLink>
