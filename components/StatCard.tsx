    ...
    <Card className="p-0 tech-accent" hover>
      <div className="flex items-center justify-between p-md md:p-lg">
        <div className="flex-1 min-w-0">
          ...
          {description && (
            <p className="text-xs md:text-sm text-text-muted mt-xs">{description}</p>
          )}
          {change && (
            <div className="flex items-center mt-xs md:mt-sm">
              ...
              <span className="text-xs md:text-sm text-text-muted ml-1">vs last month</span>
            </div>
          )}
        </div>
        {icon && (
          <div className="ml-sm p-sm md:p-md bg-primary/10 rounded-lg flex-shrink-0">
            <div className="w-5 h-5 md:w-6 md:h-6 text-primary">
              {icon}
            </div>
          </div>
        )}
