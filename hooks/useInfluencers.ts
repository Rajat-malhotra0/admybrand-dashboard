...
import { Influencer, CreateInfluencerRequest, UpdateInfluencerRequest } from '@/lib/api/types';
...
export const useInfluencers = () => {
  ...
  const updateInfluencer = async (id: number, influencerData: UpdateInfluencerRequest) => {
    try {
