      ...
      <div className="overflow-x-auto">
        <table className="min-w-full divide-y divide-border/50">
          <thead className="bg-slate-50/80 dark:bg-slate-800/50">
            <tr>
              <th className="px-sm md:px-md py-3 text-left text-xs font-semibold text-text-muted uppercase tracking-wider">
                NAME
              </th>
              <th className="px-sm md:px-md py-3 text-left text-xs font-semibold text-text-muted uppercase tracking-wider">
                PROJECTS
              ...
              <th 
                className="px-sm md:px-md py-3 text-left text-xs font-semibold text-text-muted uppercase tracking-wider cursor-pointer hover:text-primary transition-colors select-none group"
          ...
          <tbody className="bg-surface divide-y divide-border/50">
            {showNoDataMessage && leads.length === 0 ? (
              ...
              paginatedLeads.map((lead) => (
                ...
                >
                  <td className="px-sm md:px-md py-4 whitespace-nowrap">
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0 h-8 w-8 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center shadow-sm">
